...
sys.path.append('/home/mateus/IC/tcc_sfm-master_2/tcc_sfm-master')
...
if __name__ == "__main__":
    ...
    with open("/home/mateus/IC/tcc_sfm-master_2/tcc_sfm-master/config.yaml", "r") as f:
    ...
    df_combined = pd.DataFrame()               #[mbs:221007] comentado para testes
