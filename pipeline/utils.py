...
#    os.system(
#        os.path.join(
#            os.getcwd(), "visualizer", "cmake-build-debug", "visualizer" # [jo:220902] original
#            os.getcwd(), "visualizer", "visualizer" # [jo:220902] novo path
#        )
#        + " "
#        + os.path.join(os.getcwd(), "out", "viz_data.csv") # [jo:220902] original
#        + os.path.join("../run_scripts/out", "viz_data.csv") # [jo:220902] novo path
#    )
    """
    Call visualizes with default csv file location
    """
    ...
    os.system(
        os.path.join(
#            os.getcwd(), "visualizer", "cmake-build-debug", "visualizer" # [jo:220902] original
            "/home/mateus/IC/tcc_sfm-master_2/tcc_sfm-master/", "visualizer", "visualizer" # [jo:220902] novo path
        )
        + " "
#        + os.path.join(os.getcwd(), "out", "viz_data.csv") # [jo:220902] original
        + os.path.join("../run_scripts/out", "viz_data.csv") # [jo:220902] novo path
...
def compose_rts(rel_R, rel_T, comp_R, comp_T):
    """
    Properly composes two sets of rotation matrices and translation vectors
...
def get_nan_bool_mask(input_array):
    ...
    :param input_array: feature track or point clouds
    :return: bool mask
    """
    #return (np.isnan(input_array.astype(np.float))).any(axis=1)
...
def get_last_track_pair(tracks, masks):
    ...
    track_pair = [
        ...
        track[np.isin(mask, pair_mask)]     #fills with zeros where it matches
